...
const LINK_APP = 'https://xciptv.br.uptodown.com/android/download'; // <--- INSIRA O LINK DO SEU APP AQUI
...
// --- SUBSTITUÍDO: Agora o bot gera um Card de Texto em vez de imagem para evitar erros ---
...
client.on('message_create', async (msg) => {
    try {
        ...
        if (texto.startsWith('!pago ')) {
            ...
            // Envia o Card de Texto em vez da Imagem para evitar erros
